const styles = {
  ...
  heroDText:
    "mt-[7px] lg:w-[212px] md:w-[148px] sm:w-[80px] w-[60px] lg:h-[108px] md:h-[76px] sm:h-[44px] h-[33px] md:border-[18px] border-[9px] rounded-r-[50px] border-white sm:mx-2 mx-[6px]",
};
